...
module.exports = {
  ...
  SERVICE_NAME: process.env.SERVICE_NAME || "INTERVIEW_SERVICE",
  SERVICE_QUEUE: process.env.SERVICE_QUEUE || process.env.INTERVIEW_QUEUE,
  RPC_QUEUE: process.env.RPC_QUEUE || process.env.INTERVIEW_RPC,
